...
while True:
    ...
    print("WASD keys to move, H for help, C for clear, F to save, or QUIT")
    ...
    if response == "QUIT":
        ...
        print("Enter W, A, S, and D characters to move the course and")
        print("draw a lne behind it as it moves. For example, ddd")
        print("draws a line going right and sssdddwwwaaa draws a box")
        print()
        print("You can save your drawing to text file by entering F.")
